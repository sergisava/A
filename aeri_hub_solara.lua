--[[
    AERI HUB - SOLARA WRAPPER
    Optimizado para Solara executor
    No requiere chunking, carga directa por HTTP
]]
...
local function save_log()
    local path = "AeriHub_Solara_Log.txt"
...
if identifyexecutor then
    getgenv and getgenv().identifyexecutor = function() return "Solara", executor_name end
end
...
-- Metodo 1: game.HttpGet (SOLARA - no trunca)
if _HttpGet then
...
local exec_success, exec_error = _pcall(compiled)
